...
public class RootviewActivity extends Activity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		imageview1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				PopupMenu popup = new PopupMenu(RootviewActivity.this, imageview1);
				
				Menu menu = popup.getMenu();
				menu.add("NonRoot Mode");
				menu.add("Clear");
				...
				popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
					...
					public boolean onMenuItemClick(MenuItem item) {
						switch (item.getTitle().toString()) {
							...
							Intent go_to_new = new Intent(RootviewActivity.this, MainActivity.class); startActivity(go_to_new);
							return true;
		  ...
		  public static class Console implements java.io.Closeable {
				    ...
				    Console(Builder builder) throws ShellNotFoundException {
						      try {
								        ...
								        RootviewActivity aan = new RootviewActivity();
	...
	private class RunCommandTask extends AsyncTask<String, Void, CommandResult> {
		...
		@Override protected void onPreExecute() {
				dialog = ProgressDialog.show(RootviewActivity.this, "Running Command", "Please Wait...");
